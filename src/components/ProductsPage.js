...
function ProductsPage(props) {
    ...
    function searchProducts(e) {
        ...
        if (string.length > 2) {
            result = products.filter((item) => typeof item.product === 'string' && item.product.toLowerCase().indexOf(string) > -1);
        } else {
            result = products;
        }
        setItems(result);
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <ul>
                                            ...
                                            <li key={cartItem.id}>
                                                <div className="row">
                                                    <div className="col-md-12">
                                                    <img src={`https://www.farmersph.com/addons/demo/core/public/products/${cartItem.photo}`} className="photo" alt={cartItem.name} />
                                        ...
                                        {context.cart.length > 0 && <div className="cart-total">Cart Total: $ {context.total}</div>}
                                    </div>
                                </div>
                            </div>
                        </div>
